...
public class StudentTrackResponseDTO {
    ...
    public StudentTrackResponseDTO() {}

    public StudentTrackResponseDTO(Long attemptId, int currentQuestionIndex, String currentQuestionText, int answeredCount, int totalQuestions, String lastAction, Map<Integer, String> questionStatusMap) {
