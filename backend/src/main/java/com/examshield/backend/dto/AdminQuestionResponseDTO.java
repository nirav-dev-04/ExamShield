...
public class AdminQuestionResponseDTO {
    ...
    public AdminQuestionResponseDTO(Long id, Long topicId, String topicName, QuestionType type, String questionText,
                                    String optionA, String optionB, String optionC, String optionD,
                                    String correctAnswer, Difficulty difficulty, Integer marks) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public AdminQuestionResponseDTO build() {
            return new AdminQuestionResponseDTO(id, topicId, topicName, type, questionText, optionA, optionB, optionC, optionD, correctAnswer, difficulty, marks);
        }
    }
}
