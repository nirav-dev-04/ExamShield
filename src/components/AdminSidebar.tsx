...
import { Shield, BookOpen, Users, Activity, LogOut, FileText, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] overflow-hidden font-sans">
      ...
      >
        ...
        >
          <Shield size={24} className="text-[#6C4FD6] shrink-0" fill="rgba(108, 79, 214, 0.1)" />
          {!isCollapsed && (
            <div style={{ whiteSpace: "nowrap" }} className="transition-opacity duration-200">
              ...
              <p className="text-[9px] uppercase tracking-wider font-bold text-[#64748B]">Admin Console</p>
            </div>
          )}
        </div>
